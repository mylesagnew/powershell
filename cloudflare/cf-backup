# PowerShell script to Backup DNS records
...
Write-Host "Writing domain DNS files"
foreach ($domain in $domainList) {
    Export-DNS $domain
}

Write-Host "Domain DNS records complete. Please check the /domains directory for your files"
